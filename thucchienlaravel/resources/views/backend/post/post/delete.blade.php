<div class="overflow">
    ...
    <form action="{{route('post.post.destroy',$posts->id)}}" method="post" class="box">
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="panel-head">
                        ...
                        <div class="panel-description">ban dang muon xoa nhom thanh vien co ten la  la:「{{$posts->name }}」</div>
